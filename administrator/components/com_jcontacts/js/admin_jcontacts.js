function accountPopup() {
	...
	accountpopup = open("components/com_jcontacts/popup/account.php","WSDClient","scrollbars=yes,width=550,height=350,resizable=yes")
...
function reportPopup() {
	...
	reportpopup = open("components/com_jcontacts/popup/report_to.php","WSDClient","scrollbars=yes,width=550,height=350,resizable=yes")
...
function checkEmailField() {
	...
	if (form.juser.checked == true) {


		if (value == "") {


			document.getElementById("email_label").className="fieldNameRequired";


		} else {


			document.getElementById("email_label").className="fieldNameRequiredActive";
...
function fieldCheck(task) {


	if (task == 'contact') {


		var field = new Array("last_name", "account_id", "email", "username");


	} else if (task == 'account') {


		var field = new Array("name");	


	} else if (task == 'lead') {


		var field = new Array("last_name");	
...
function toggleUserFields() {
	...
	if (form.juser.checked == true) {
		...
		form.verifyPass.disabled = false;
		...
		document.getElementById("username_label").className ="fieldNameRequired";
		...
		form.verifyPass.disabled = true;


		


		document.getElementById("email_label").className ='fieldName';


		document.getElementById("username_label").className ='fieldName';
...
if (x == "billing") {
	var mBox3 = document.getElementById("billing_state");
} else {
	var mBox3 = document.getElementById("mailing_state");
}

   var mBox4 = document.getElementById("mzip");

if (x == "billing") {
	var mBox5 = document.getElementById("billing_country");
} else {
	var mBox5 = document.getElementById("mailing_country");
}
...
if (x == "billing") {
	var oBox3 = document.getElementById("shipping_state");
} else {
	var oBox3 = document.getElementById("other_state");
}

   var oBox4 = document.getElementById("ozip");

if (x == "billing") {
	var oBox5 = document.getElementById("shipping_country");
} else {
	var oBox5 = document.getElementById("other_country");
}
